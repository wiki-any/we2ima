function initDomDistiller() {
  const $gwt_version = '2.7.0';
  const $wnd = window;
  const $doc = $wnd.document;
  let $moduleName, $moduleBase;
  const $stats = $wnd.__gwtStatsEvent
    ? function (a) {
        $wnd.__gwtStatsEvent(a);
      }
    : null;
  const $strongName = '4EF74B0AFE27B1FAE6BEBDB0F622E7D1';
  let aa = 2147483647,
    ba = { 3: 1, 12: 1 },
    ca = { 3: 1, 15: 1, 12: 1 },
    da = { 3: 1, 4: 1 },
  ...
  function n(a, b, c) {
    ...
    d && !e ? (_ = d) : ((_ = pa[a] = b ? ra(pa[b]) : {}), (_.cM = c), (_.constructor = _), !b && (_.tM = qa));
      ...
      if (null != c) a = c;
        ...
        if (null == c) {
          ...
          for (c = 0; c < f; )
            (d =
              a.charCodeAt(c + 3) +
              31 * (a.charCodeAt(c + 2) + 31 * (a.charCodeAt(c + 1) + 31 * (a.charCodeAt(c) + 31 * d)))),
              (d = ~~d),
              (c += 4);
  ...
  _.tS = function () {
    return (0 != (this.f & 2) ? 'interface ' : 0 != (this.f & 1) ? '' : 'class ') + (Za(this), this.n);
  };
  _.f = 0;
  _.i = 0;
  var cb = 1,
        ...
        null == a
          ...
          : null == a || va(a) || a.tM === qa
            ...
            : null == a
              ? null
              : a.name),
      (this.a = `${this.a}: ${null == a || va(a) || a.tM === qa ? `${a}` : null == a ? null : a.message}`),
  ...
  _.s = function (a, b) {
    const c = {};
    a.fnStack = [];
    for (let d = arguments.callee.caller; d; ) {
      sc();
      var e;
      if (!(e = d.name)) {
        e = d;
  ...
  function Tc(a, b) {
    ...
    if (d < b.length) {
      c.a += ' [';
      e = b[d++];
      for (c.a += e; d < b.length; ) (c.a += ', '), (e = b[d++]), (c.a += e);
      c.a += ']';
    }
    return c.a;
  }
  ...
  function ce() {
    Wc();
    return D(w(ue, 1), ea, 10, 0, [Xc, Zc, ad, kd, vd, Dd, Fd, Hd, Jd, Ld, Nd, Pd, Rd, Td, Vd, Xd, Zd, ae]);
  }
  n(10, 9, ga);
  var Zc,
    Zd,
  ...
  function Ce() {
    ...
    b = {};
    d = 0;
    for (e = a.length; d < e; ++d) (c = a[d]), (b[`:${null != c.a ? c.a : `${c.b}`}`] = c);
    Je = b;
  }
  let Je;
  function Me(a, b) {
  ...
  function Re(a, b, c, d, e, f) {
    ...
    let g = b;
    for (b += e; g < b; ) {
      const l = Math.min(g + 1e4, b);
      e = l - g;
      Array.prototype.splice.apply(c, [d, f ? e : 0].concat(a.slice(g, l)));
      g = l;
      d += e;
    }
  }
  function rc(a) {
    return r(a, 39) && s(a.b) !== s((sb(), fc)) ? (s(a.b) === s(fc) ? null : a.b) : a;
  }
  function qc(a) {
    let b;
    if (r(a, 12)) return a;
  ...
  function gf(a) {
    let b, c;
    return -129 < a && 128 > a ? ((b = a + 128), (c = (hf(), jf)[b]), !c && (c = jf[b] = new ff(a)), c) : new ff(a);
  }
  ...
  function pf(a, b, c) {
    ...
    65536 <= b
      ? ((d = (56320 + ((b - 65536) & 1023)) & 65535),
        (b = String.fromCharCode((55296 + (((b - 65536) >> 10) & 1023)) & 65535) + String.fromCharCode(d)))
      : (b = String.fromCharCode(b & 65535));
    return a.lastIndexOf(b, c);
  }
  function qf(a, b, c, d, e) {
    if (null == c) throw new Rc();
    if (0 > b || 0 > d || 0 >= e || b + e > a.length || d + e > c.length) return !1;
    a = a.substr(b, e);
    c = c.substr(d, e);
    return a === c;
  }
  ...
  function xf(a) {
    ...
    for (b = 0; 0 <= (b = a.indexOf('\\', b)); )
      36 == a.charCodeAt(b + 1) ? (a = `${a.substr(0, b)}$${dg(a, ++b)}`) : (a = a.substr(0, b) + dg(a, ++b));
    return a;
  }
  var p = t(2);
  function Ia() {
  ...
  function $g(a, b) {
    ...
    e = b.X();
    d = a.P(c);
    return !(s(e) === s(d) || (null != e && ta(e, d))) || (null == d && !a.N(c)) ? !1 : !0;
  }
  function ah(a, b) {
    let c, d, e;
    for (d = a.O().D(); d.Q(); ) if (((c = d.R()), (e = c.W()), s(b) === s(e) || (null != b && ta(b, e)))) return c;
    return null;
  }
  function bh(a, b) {
  ...
  _.tS = function () {
    ...
    a = !1;
    for (c = this.O().D(); c.Q(); )
      (b = c.R()), a ? (d.a += ', ') : (a = !0), (d.a += bh(this, b.W())), (d.a += '\x3d'), (d.a += bh(this, b.X()));
    d.a += '}';
    return d.a;
  };
  t(211);
  ...
  _.eQ = function (a) {
    ...
    d = a.D();
    for (b = this.D(); b.Q(); ) if (((a = b.R()), (c = d.R()), !(s(a) === s(c) || (null != a && ta(a, c))))) return !1;
    return !0;
  };
  _.hC = function () {
    let a, b, c;
    c = 1;
    for (b = this.D(); b.Q(); ) (a = b.R()), (c = 31 * c + (null != a ? Ha(a) : 0)), (c = ~~c);
    return c;
  };
  _.D = function () {
    return new M(this);
  ...
  _.U = function (a) {
    ...
    b = Nh(this, a);
    try {
      return (c = (y(b.b != b.d.c), (b.c = b.b), (b.b = b.b.a), ++b.a, b.c.c)), Ph(b), c;
    } catch (d) {
      d = qc(d);
  ...
  function Sh(a, b) {
    for (let c = 0; c < a.b.length; ++c) if (Bh(b, a.b[c])) return c;
    return -1;
  }
  function Th(a, b) {
    let c;
  ...
  function Xh(a, b, c, d, e, f) {
    ...
    if (7 > d - c)
      for (a = c, g = a + 1; g < d; ++g)
        for (m = g; m > a && 0 < f.Z(b[m - 1], b[m]); --m) (c = b[m]), (b[m] = b[m - 1]), (b[m - 1] = c);
    else if (
      ((l = c + e),
      (g = d + e),
      (m = l + ((g - l) >> 1)),
      ...
      for (; c < d; ) b[c++] = a[l++];
    else for (e = l, l = m; c < d; ) l >= g || (e < m && 0 >= f.Z(a[e], a[l])) ? (b[c++] = a[e++]) : (b[c++] = a[l++]);
  }
  function Yh(a) {
    this.a = a;
  }
  ...
  function dh(a) {
    let b, c;
    c = 0;
    for (b = a.D(); b.Q(); ) (a = b.R()), (c += null != a ? Ha(a) : 0), (c = ~~c);
    return c;
  }
  function Zh() {
    Zh = k;
  ...
  function fh(a, b) {
    ...
    d = a.a[c] || [];
    e = 0;
    for (f = d.length; e < f; ++e) if (((c = d[e]), ri(b, c.W()))) return c;
    return null;
  }
  function ih(a, b, c) {
    let d, e, f, g;
    ...
    d = e[d] || (e[d] = []);
    f = 0;
    for (g = d.length; f < g; ++f) if (((e = d[f]), ri(b, e.W()))) return e.Y(c);
  ...
  _._ = function () {
    let a = this.ab(),
      b = this.a,
      c;
    for (c in b) if (c == parseInt(c, 10)) for (let d = b[c], e = 0, f = d.length; e < f; ++e) a.F(d[e]);
    return a.D();
  };
  _.ab = function () {
    return new oj(this);
  ...
  function kh() {
    ...
    lh = b
      ? ((a = Object.create(null)), (a.__proto__ = 42), 0 == Object.getOwnPropertyNames(a).length)
        ? new Ej()
        : new tj()
      : new Fj();
  }
  ...
  _.R = function () {
    return y(this.b != this.d.c), (this.c = this.b), (this.b = this.b.a), ++this.a, this.c.c;
  };
  _.V = function () {
    Ph(this);
  };
    ...
    if (b) {
      ...
      sk(b.a[e]) &&
        (sk(b.a[1 - e])
          ...
          : sk(b.a[e].a[e])
            ? (b = tk(b, 1 - e))
            : sk(b.a[e].a[1 - e]) && (b = ((f = 1 - (1 - e)), (b.a[f] = tk(b.a[f], f)), tk(b, 1 - e))));
    } else return c;
    return b;
  }
  function sk(a) {
  ...
  function Jk(a) {
    ...
    if (!(0 < a.a.b)) {
      ...
      let d = $doc.title,
        ...
        f;
      c = f = '';
      p == p ? (f = c = d) : e && ((d = e.getElementsByTagName('TITLE')), 0 < d.length && (f = c = Lk(d[0])));
      if (f.length) {
        T();
        if (/ [\|\-] /i.test(f))
          (f = c.replace(RegExp('(.*)[\\|\\-] .*', 'gi'), '$1')),
            3 > Mk.Bb(f) && (f = c.replace(RegExp('[^\\|\\-]*[\\|\\-](.*)', 'gi'), '$1'));
        else if (-1 != f.indexOf(': '))
          (f = c.replace(RegExp('.*:(.*)', 'gi'), '$1')),
            3 > Mk.Bb(f) && (f = c.replace(RegExp('[^:]*[:](.*)', 'gi'), '$1'));
  ...
  t(104);
  function Sk(a) {
    let b, c, d, e, f, g, l, m, q, v, J, tb, Ca, si, xn, ti, ia, tf, uf, yn, zn;
    v = U();
    let An = Lk($doc.documentElement),
      Bn,
      Cn;
    T();
    Mk =
    ...
    yi = new Rk();
    fe = new Xk();
    Hn = Yk(c.b, 'meta[name\x3d"viewport"][content*\x3d"width\x3ddevice-width"]');
    vf = new Zk(fe);
    vf.i = 0 < Hn.length;
    let zi;
    const Kn = c.b;
    ...
    1 == uc.b.length
      ...
      : ((wf = Yk(Kn, '[itemscope][itemtype*\x3d"Article"],[itemscope][itemtype*\x3d"Posting"]')),
        (uc = $k(wf)),
    ...
    if (ua != Da.a.b.length) {
      ...
      for (++ua; ua < Da.a.b.length; ua++)
        r(N(Da.a, ua), 35) &&
          ((yf = N(Da.a, ua).d),
          yf == Bi ? fl(ge, new el(Da.a, ua)) : ((ed.b[ed.b.length] = ge), (Bi = yf), (ge = new el(Da.a, ua))));
      ed.b[ed.b.length] = ge;
    }
    K = new gl(ed);
    let yr = c.a,
    ...
    for (ub = new M(zr.a); ub.b < ub.d.J(); ) {
      ...
      14 < Fi.d
        ? (Ei = !1)
        : ((ie = Ok(Fi.g)),
          (Ei = 8 <= ie.length ? jl.test(ie) : 1 == Fi.c ? 'Comment' === ie : 'Shares' === ie ? !0 : !1));
    ...
    if (0 == La.b.length) Q = !1;
      ...
      for (Fa = 0; Fa < La.b.length; Fa++)
        (le = 0 == Fa ? null : (z(Fa - 1, La.b.length), La.b[Fa - 1])),
          ...
          (ke = Fa + 1 == La.b.length ? null : (z(Fa + 1, La.b.length), La.b[Fa + 1])),
          (Bf |=
            (0.333333 >= je.c
              ? !le || 0.555556 >= le.c
                ? 16 >= je.d
      ...
      for (xb = me.R(); me.Q(); )
        if (
          ...
          if (xb.a) {
            ...
            me.V();
            const ao = Ga;
            S(ao.b, 'de.l3s.boilerpipe/HEADING') && ao.b.a.c.ib('de.l3s.boilerpipe/HEADING');
    ...
    for (eb = new M(ho); eb.b < eb.d.J(); )
      (Mi = (y(eb.b < eb.d.J()), eb.d.T((eb.c = eb.b++)))),
        Mi.a || (null != Br.a && S(Mi.b, 'de.l3s.boilerpipe/TITLE')) || (sh(eb), (Li = !0));
    Q = Li;
    hl(K, Q, 'BlockFilter');
    Q = sl(xl, K);
    ...
    if (2 > fd.b.length) Q = !1;
      ...
      for (Ab = new M(fd); Ab.b < Ab.d.J(); )
        (Ma = (y(Ab.b < Ab.d.J()), Ab.d.T((Ab.c = Ab.b++)))),
          Ma.a && ((Pi = Ma.d), Pi > Oi && ((yb = Ma), (Oi = Pi), (ne = Ni))),
          ++Ni;
      for (zb = new M(fd); zb.b < zb.d.J(); )
        (Ma = (y(zb.b < zb.d.J()), zb.d.T((zb.c = zb.b++)))),
          Ma == yb
            ? (ml(Ma, !0), R(Ma.b, 'de.l3s.boilerpipe/VERY_LIKELY_CONTENT'))
      ...
      if (Cr.a && -1 != ne) {
        ...
        for (Qi = new th(fd, Dr + 1); Qi.Q(); )
          (Bb = Qi.R()),
            ...
            B(Ri) == B(lo) &&
              (ml(Bb, !0), R(Bb.b, 'SIBLING_OF_MAIN_CONTENT'), (Ri = B(Al(N(Bb.j, N(Bb.i, Bb.i.b.length - 1).a)))));
        let Er = ne,
          Cb,
          mo,
          Si,
        ...
        for (gd = new th(fd, Er); 0 < gd.b; )
          (Cb = (y(0 < gd.b), N(gd.a, (gd.c = --gd.b)))),
            ...
            B(Si) == B(mo) && (ml(Cb, !0), R(Cb.b, 'SIBLING_OF_MAIN_CONTENT'), (Si = B(Bl(N(Cb.j, N(Cb.i, 0).a)))));
      }
      Q = !0;
    }
    hl(K, Q, 'Keep Largest Block');
    let If, vc, Jf, hd, Db, Eb, oe;
    Jf = 0;
    vc = oe = -1;
    for (Eb = new M(K.a); Eb.b < Eb.d.J(); )
      (hd = (y(Eb.b < Eb.d.J()), Eb.d.T((Eb.c = Eb.b++)))),
        -1 == vc && S(hd.b, 'de.l3s.boilerpipe/TITLE') && ((oe = Jf), (vc = -1)),
        -1 == vc && hd.a && (vc = Jf),
        ++Jf;
    if (vc <= oe || -1 == oe) Q = !1;
    else {
      ...
      for (Db = new M(new vh(K.a, oe, vc)); Db.b < Db.d.J(); )
        (hd = (y(Db.b < Db.d.J()), Db.d.T((Db.c = Db.b++)))),
          S(hd.b, 'de.l3s.boilerpipe/MIGHT_BE_CONTENT') && (If |= ml(hd, !0));
      Q = If;
    }
    ...
    for (Gb = new M(K.a); Gb.b < Gb.d.J(); )
      if (
        ((fb = (y(Gb.b < Gb.d.J()), Gb.d.T((Gb.c = Gb.b++)))), fb.a && S(fb.b, 'de.l3s.boilerpipe/VERY_LIKELY_CONTENT'))
      ) {
        Kf = fb.f;
        break;
      }
    ...
    for (Hb = new M(K.a); Hb.b < Hb.d.J(); )
      (gb = (y(Hb.b < Hb.d.J()), Hb.d.T((Hb.c = Hb.b++)))),
        gb.a && S(gb.b, 'de.l3s.boilerpipe/VERY_LIKELY_CONTENT')
          ? (Lf = gb.f)
          : gb.f > Lf && S(gb.b, 'de.l3s.boilerpipe/MIGHT_BE_CONTENT') && S(gb.b, 'de.l3s.boilerpipe/LI') && 0 == gb.c
            ? (ml(gb, !0), (Ui = !0))
            : (Lf = aa);
    Q = Ui;
    ...
    let Fr = c.d,
      ...
      Ib;
    Mf = 0;
    for (Ib = new M(K.a); Ib.b < Ib.d.J(); ) (Wi = (y(Ib.b < Ib.d.J()), Ib.d.T((Ib.c = Ib.b++)))), Wi.a && (Mf += Wi.d);
    Vi = Mf;
    if (void 0 == Vi) throw new TypeError();
    Fr[1] = Vi;
    let Gr, Jb;
    for (Jb = new M(K.a); Jb.b < Jb.d.J(); ) {
      let Nf = (Gr = (y(Jb.b < Jb.d.J()), Jb.d.T((Jb.c = Jb.b++)))),
        no = void 0,
        Kb = void 0,
        Xi = void 0;
      if (Nf.a)
        for (Kb = new M(Nf.i); Kb.b < Kb.d.J(); )
          (no = (y(Kb.b < Kb.d.J()), Kb.d.T((Kb.c = Kb.b++)))),
            (Xi = N(Nf.j, no.a)),
            (Xi.p = !0),
            S(Nf.b, 'de.l3s.boilerpipe/TITLE') && R(Xi.e, 'de.l3s.boilerpipe/TITLE');
    }
    let Of, Lb, Pf;
    Pf = !1;
    ...
    for (Nb = new M(oo.a); Nb.b < Nb.d.J(); )
      (Na = (y(Nb.b < Nb.d.J()), Nb.d.T((Nb.c = Nb.b++)))), r(Na, 35) && Na.p && (!id && (id = Na), (Rf = Na));
    if (Rf) {
      for (
        Mb = new M(oo.a);
        Mb.b < Mb.d.J() &&
        !((Na = (y(Mb.b < Mb.d.J()), Mb.d.T((Mb.c = Mb.b++)))), ((po = r(Na, 32)) && Na.p) || Na == Rf);

      )
        po && O(Qf, Na);
      let pe, Yi, Zi, qe, qo, Sf, Ob, jd;
      if (0 != Qf.b.length) {
        Zi = null;
        id && (Zi = N(id.a, id.c));
        qo = ((jd = new P()), O(jd, new Cl()), O(jd, new Dl()), O(jd, new El(Zi)), O(jd, new Fl()), jd);
        pe = null;
        Yi = 0;
        for (Ob = new M(Qf); Ob.b < Ob.d.J(); ) {
          ...
          if (Sf) {
            ...
            for (Pb = new M(qo); Pb.b < Pb.d.J(); )
              (vo = (y(Pb.b < Pb.d.J()), Pb.d.T((Pb.c = Pb.b++)))), (re += vo.Gb(Tf));
            2 > Wk || (Tf ? V(`FINAL SCORE: ${re} : ${A(Tf, 'src')}`) : V('Null image attempting to be scored!'));
            qe = re;
          } else qe = 0;
    ...
    for (Sb = new M(Jr.a); Sb.b < Sb.d.J(); )
      if (((Pa = (y(Sb.b < Sb.d.J()), Sb.d.T((Sb.c = Sb.b++)))), Pa.p))
        if (r(Pa, 32)) Rh(Vf, (!Pa.b && Il(Pa), (Wf = new P()), !Pa.e.length || O(Wf, Pa.e), Rh(Wf, Jl(Pa.b)), Wf));
        else if (r(Pa, 69)) {
          let Kr = Vf,
            Xf = Pa,
            Yf = void 0,
          ...
          for (Yf = 0; Yf < dj.length; Yf++) (Zf = dj[Yf]), !Zf.src.length || O($f, Zf.src), Rh($f, Jl(Zf));
          Rh(Kr, $f);
        }
    c.c = Vf;
    if (4 <= Wk) {
    ...
    if ('pagenum' === hj) {
      ...
      if (ia.d) {
        ...
        for (md = 0; md < jj.length; )
          (bg = jj[md]),
            (Jo = Sl(ia, bg, kj))
              ...
              : ++md;
        const ve = ia.a;
        0 != ve.a.b.length && 0 == N(ve.a, ve.a.b.length - 1).b.b.length && ve.a.U(ve.a.b.length - 1);
        ...
        if ((gg = Pl(Mo))) {
          ...
          for (Tb = new M(Qr.a); Tb.b < Tb.d.J(); )
            if (((fg = (y(Tb.b < Tb.d.J()), Tb.d.T((Tb.c = Tb.b++)))), !(2 > fg.b.b.length))) {
              for (
                var xa = fg.b,
                  Rr = 0 > fg.a,
                  pj = gg,
                ...
                (No = (y(Ub.b < Ub.d.J()), Ub.d.T((Ub.c = Ub.b++)))), !No.b.length || ++pd;
              if (0 == pd) hg = null;
              else {
                if (Rr)
                  for (
                    var xc = xa, qd = void 0, rd = void 0, Oo = void 0, rd = 0, qd = xc.b.length - 1;
                    rd < qd;
                    ++rd, --qd
                  )
                    (Oo = (z(rd, xc.b.length), xc.b[rd])), Uh(xc, rd, (z(qd, xc.b.length), xc.b[qd])), Uh(xc, qd, Oo);
                2 == xa.b.length &&
                  1 == pd &&
                  1 == (z(0, xa.b.length), xa.b[0]).a &&
                  2 == (z(1, xa.b.length), xa.b[1]).a &&
                  (of((z(0, xa.b.length), xa.b[0]).b) ? Uh(xa, 0, new Yl(1, Xa(pj.d))) : Uh(xa, 1, new Yl(2, Xa(pj.d))),
                  ++pd);
                var ig;
                if (2 <= pd) {
                  for (
                    ...
                    (Ro = (y(Xb.b < Xb.d.J()), Xb.d.T((Xb.c = Xb.b++)))), Ro.a == ye + 1 && ++ye;
                  if (28 <= ye && 31 >= ye) ig = null;
                    ...
                    for (zc = 0; zc < Ra.b.length; zc++)
                      if (((Wb = (z(zc, Ra.b.length), Ra.b[zc])), Wb.b.length && ((xe = Pl(Wb.b)), (kg[zc] = xe)))) {
                        xe.d.username = '';
                        xe.d.password = '';
                        let To = xe,
                          Vr = Wb.a,
                        ...
                        if (null == Ac.b)
                          if (((pg = Ac.d.search), pg.length))
                            for (
                              ng = (T(), Gf(pg.substr(1, pg.length - 1), '\\\x26')), Ac.b = Pe([ng.length, 2]), ud = 0;
                              ud < ng.length;
                              ud++
                            )
                              (og = Gf(ng[ud], '\x3d')),
                                (Ac.b[ud][0] = og[0]),
                                (Ac.b[ud][1] = 1 < og.length ? og[1] : '');
                          else Ac.b = Pe([0, 2]);
                        mg = Ac.b;
                        if (0 != mg.length)
                    ...
                    if (0 == we.a.b)
                      for (Vb = 0; Vb < Ra.b.length; Vb++)
                        if (((Wb = (z(Vb, Ra.b.length), Ra.b[Vb])), kg[Vb])) {
                          var Bc = kg[Vb],
                            Yr = Wb.a,
                            Zr = Vb,
                            $r = we,
                            ...
                            Be = void 0,
                            Xo = void 0,
                            wj = (null == Bc.c && (Bc.c = dm(Bc.d)), Bc.c);
                          if (wj.length && em(wj))
                            for (
                              Xo = Xa(Bc.d),
                    ...
                    for (sd = new oh(new nh(we.a).a); ph(sd); ) {
                      if (sd._gwt_modCount != sd.c._gwt_modCount) throw new rh();
                      qj = (y(ph(sd)), sd.a.R());
                      Qo = qj.W();
                      td = qj.X();
                      if (!(Qo === Tr || 100 < td.a.b.length) && td.b.Ab(Po)) {
                        e: {
                          let yj = td.b,
                            Cc = td.a,
                            Yb = Ra,
                            ...
                            Cj = void 0;
                          if (2 <= Cc.b.length)
                            if (((Ee = hm(Cc, Yb)), Ee.a && Ee.b && im(Yb, Ee))) {
                              $o = jm(Cc);
                              hb = new P();
                              for (Zb = new M(Cc); Zb.b < Zb.d.J(); )
                                (Bj = (y(Zb.b < Zb.d.J()), Zb.d.T((Zb.c = Zb.b++)))),
                                  O(hb, new Yl(Bj.a, N(Yb, Bj.c).b));
                              Sa = new km((lm(), mm), yj.tS(), hb, $o, Ee.c);
                            } else Sa = null;
                          else {
                            if (
                              1 == Cc.b.length &&
                              ...
                              (ap = 2 == Ta.a && 1 == Ta.c),
                              (Cj = 3 == Ta.a && 2 == Ta.c && 2 == (z(1, Yb.b.length), Yb.b[1]).a),
                              1 == (z(0, Yb.b.length), Yb.b[0]).a && (ap || Cj) && yj.zb(zj))
                            ) {
                              De = Ta.b - Ta.a;
                              0 == De || 1 == De ? (Aj = 1) : ((Aj = Ta.b), (De = 0));
                              hb = new P();
                              O(hb, new Yl(1, zj));
                        ...
                        if (Sa) {
                          var yc = (!om && (om = /\/$/), Po.d.href.replace(om, '')),
                            Fe;
                          e: {
                            let wd = Sa,
                              Gj = yc,
                              ...
                              tg = void 0,
                              $b = void 0;
                            if (2 > wd.a.b.length || 1 == N(wd.a, 0).a || Gj.length >= N(wd.a, 0).b.length) Fe = !1;
                            else {
                              for (xd = 0; xd < wd.a.b.length; xd++) {
                                var Hj;
                                (Hj = N(wd.a, xd).a != xd + 2) || (Hj = N(wd.a, xd).b === Gj);
                                if (Hj) {
                                  Fe = !1;
                                  break e;
                                }
                          ...
                          Fe
                            ...
                            : td.b.zb(yc) &&
                              ((jg = N(Sa.a, 0)),
                              2 == jg.a && jg.b !== yc && yc.length < jg.b.length && wh(Sa.a, 0, new Yl(1, yc)));
                          pm(lg, new qm(Sa));
                        }
                      }
                    }
      ...
      Kj = `${es + ip}/`;
      const fs = `^${Kj.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, '\\$\x26')}.*\\d`;
      fp = RegExp(fs, 'i');
      for (Ge = 0; Ge < Ec.length; Ge++)
        if (((L = Ec[Ge]), (hp = A(L, 'href')), Mj.setAttribute('href', hp), (ja = Mj.href), fp.test(ja)))
          if (((Rj = (L.offsetWidth || 0) | 0), (Oj = (L.offsetHeight || 0) | 0), 0 == Rj || 0 == Oj))
            X(L, `ignored: sz\x3d${Rj}x${Oj}`);
          else if (vm(L))
            if (((ja = ja.replace(wm, '')), X(L, `-\x3e ${ja}`), F(ja, gp) || F(ja, ib)))
              X(L, `ignored: same as current or folder url ${ib}`);
            else if (((cc = Nk(L)), 25 < cc.length)) X(L, 'ignored: link text too long');
            else if (xm.test(cc)) X(L, 'ignored: one of extra'), R(Lj, ja);
            else if (((Pj = ja), ja.substr(0, ib.length) === ib && (Pj = dg(ja, ib.length)), ym.test(Pj))) {
              x = new zm(Ge, cc, ja);
              R(yg, x);
              0 != ja.indexOf(ib) && ((x.d -= 25), X(L, `score\x3d${x.d}: not part of folder url ${ib}`));
              bc = `${cc} ${A(L, 'class')} ${L.id}`;
              X(L, `txt+class+id\x3d${bc}`);
              Am.test(bc) && ((x.d += 50), X(L, `score\x3d${x.d}: has next`));
              Bm.test(bc) && ((x.d += 25), X(L, `score\x3d${x.d}: has pag* word`));
              Cm.test(bc) && !Am.test(x.c) && ((x.d -= 65), X(L, `score\x3d${x.d}: has first|last but no next regex`));
              if (Dm.test(bc) || xm.test(bc)) (x.d -= 50), X(L, `score\x3d${x.d}: has neg or extra regex`);
              Em.test(bc) && ((x.d -= 200), X(L, `score\x3d${x.d}: has opp of next regex`));
              wg = xg = !1;
              for (Ad = B(L); Ad && (!xg || !wg); )
                (Bd = `${A(Ad, 'class')} ${Ad.id}`),
                  !xg && Bm.test(Bd) && ((x.d += 25), (xg = !0), X(L, `score\x3d${x.d}: posParent - ${Bd}`)),
                  wg ||
                    !Dm.test(Bd) ||
                    Fm.test(Bd) ||
                    ((x.d -= 25), (wg = !0), X(L, `score\x3d${x.d}: negParent - ${Bd}`)),
                  (Ad = B(Ad));
              if (Gm.test(ja) || Bm.test(ja)) (x.d += 25), X(L, `score\x3d${x.d}: has paging info`);
              xm.test(ja) && ((x.d -= 15), X(L, `score\x3d${x.d}: has extra regex`));
              10 < cc.length && ((x.d -= cc.length), X(L, `score\x3d${x.d}: text too long`));
              yd = Hm(cc);
              0 < yd &&
                (1 == yd ? (x.d -= 10) : (x.d += 0 > 10 - yd ? 0 : 10 - yd),
                X(L, `score\x3d${x.d}: linktxt is a num (${yd})`));
              for (
                var kb = g,
                  lb = ja,
                  qp = L,
                  ...
                  lb = Im(lb),
                  Fc = gs;
                Fc < lf(kb.length, lb.length) && kb.charCodeAt(Fc) == lb.charCodeAt(Fc);
                Fc++
              );
              ...
              (Nj = 0 < Cg && 0 < Bg ? gf(Bg - Cg) : null) &&
                1 == Nj.a &&
                ((x.d += 25), X(L, `score\x3d${x.d}: diff \x3d ${Nj}`));
      ...
      if (0 != yg.a.b)
        for (Qj = xh(new zh(yg.a)); ph(Qj.a); )
          (He = qh(Qj.a).W()), S(Lj, He.a) || (50 <= He.d && (!jb || jb.d < He.d) && (jb = He));
      zd = null;
      if (jb) {
        const hs = jb.a;
        T();
        zd = hs.replace(RegExp('\\/$', 'gi'), '');
        X(Ec[jb.b], `found: score\x3d${jb.d}, txt\x3d[${jb.c}], ${zd}`);
      }
      if (3 <= Wk) {
        let Ke, Dg, dc, Le, Eg;
        V(`numLinks\x3d${Ec.length}, found next: ${null != zd ? zd : 'null'}`);
        for (Ke = 0; Ke < Ec.length; Ke++) {
          Dg = Ec[Ke];
          dc = Nk(Dg);
          Eg = (T(), Gf(dc, '\\s+'));
          dc = '';
          for (Le = 0; Le < Eg.length; Le++) (dc += Eg[Le]), Le < Eg.length - 1 && (dc += ' ');
          V(`${Ke})${Dg.href}, txt\x3d[${dc}], dbg\x3d[${gh(um, Dg)}]`);
        }
      }
      uf = zd;
      if (null != uf) {
    ...
    if (!Ig) {
      ...
      let Yj, Jg, Kg;
      Kg = '';
      for (Jg = 0; Jg < fa.a.b.length && !Kg.length; Jg++) Kg = N(fa.a, Jg).vb();
      Yj = Kg;
      if (void 0 == Yj) throw new TypeError();
      ya[2] = Yj;
      let Zj, Lg, Mg;
      Mg = '';
      for (Lg = 0; Lg < fa.a.b.length && !Mg.length; Lg++) Mg = N(fa.a, Lg).wb();
      Zj = Mg;
      if (void 0 == Zj) throw new TypeError();
      ya[3] = Zj;
      let ak, Ng, Og;
      Ng = '';
      for (Og = 0; Og < fa.a.b.length && !Ng.length; Og++) Ng = N(fa.a, Og).rb();
      ak = Ng;
      if (void 0 == ak) throw new TypeError();
      ya[4] = ak;
      let bk, Pg, Qg;
      Qg = '';
      for (Pg = 0; Pg < fa.a.b.length && !Qg.length; Pg++) Qg = N(fa.a, Pg).tb();
      bk = Qg;
      if (void 0 == bk) throw new TypeError();
      ya[5] = bk;
      let ck, Rg, Sg;
      Rg = '';
      for (Sg = 0; Sg < fa.a.b.length && !Rg.length; Sg++) Rg = N(fa.a, Sg).qb();
      ck = Rg;
      if (void 0 == ck) throw new TypeError();
      ya[6] = ck;
      let dk, Tg, Ug;
      Tg = '';
      for (Ug = 0; Ug < fa.a.b.length && !Tg.length; Ug++) Tg = N(fa.a, Ug).pb();
      dk = Tg;
      ...
      let Xg, Yg;
      Yg = null;
      for (Xg = 0; Xg < fa.a.b.length && !((Yg = N(fa.a, Xg).sb()), 0 < Yg.length); Xg++);
      Uj = Yg;
  ...
  function Kl(a) {
    ...
    b = new Lm(a);
    let c = (z(0, a.b.length), a.b[0]),
      d;
    for (d = c.parentNode; d && 9 != d.nodeType; c = d, d = d.parentNode);
    bl(new cl(b), c);
    b = b.c;
    for (a = (z(0, a.b.length), a.b[0]); 1 == b.a.b && b.b != a && 3 != Mh(b.a, 0).b.nodeType; ) b = Mh(b.a, 0);
    a = Mm(b);
  ...
  function Sm(a) {
    W();
    return a ? ((a.offsetHeight || 0) | 0) * ((a.offsetWidth || 0) | 0) : 0;
  }
  function Tm(a) {
    W();
    return a.attributes;
  ...
  function Rm(a) {
    ...
    d = $m(a);
    for (a = 0; a < d.length; a++) (b = Ok(d[a])), b.length && ((b = Gf(b, ' ')), O(c, b[0]));
    return c;
  }
  function an(a) {
    W();
  ...
  function U() {
    W();
    return ('undefined' !== typeof distiller_on_ios && distiller_on_ios) || !window.performance
      ? Date.now()
  ...
  function $k(a) {
    ...
    for (c = 0; c < a.length; c++)
      (b = a[c]),
        vm(b) &&
          (b.offsetParent || 0 != ((b.offsetHeight || 0) | 0) || 0 != ((b.offsetWidth || 0) | 0)) &&
          0 < Sm(b) &&
          (d.b[d.b.length] = b);
    return d;
  }
  ...
  function Om(a) {
    ...
    'VIDEO' === a.tagName && ((c = a), c.poster.length && (c.poster = c.poster));
  ...
  function cn(a) {
    W();
    ('IMG' == a.tagName || 'SOURCE' == a.tagName || 'TRACK' == a.tagName || 'VIDEO' == a.tagName) &&
      a.src &&
      (a.src = a.src);
    a = a.querySelectorAll('img,source,track,video');
    for (const b in a) a[b].src && (a[b].src = a[b].src);
  }
  function dn(a) {
    W();
    let b;
  ...
  function en(a) {
    ...
    if (d.length) {
      ...
      for (d = 0; d < e.length; d++)
        (b = Ok(e[d])), b.length && ((b = Gf(b, ' ')), (c.src = b[0]), (b[0] = c.src), (e[d] = fn(b, ' ')));
      c = fn(e, ', ');
  ...
  function hn(a) {
    let b, c, d;
    c = Tm(a);
    for (d = 0; d < c.length; ) (b = c[d].nodeName), S(Km, b) ? ++d : a.removeAttribute(b);
  }
  function Nm(a, b, c) {
    W();
    let d, e, f;
  ...
  function Pm(a) {
    ...
    for (c = 0; c < b.length; )
      (d = b[c].nodeName),
        'src' === d || 'alt' === d || 'srcset' === d || 'dir' === d || 'width' === d || 'height' === d || 'title' === d
          ? ++c
          : a.removeAttribute(d);
  }
  let Km;
    ...
    if (!this.f) {
      ...
      for (c = 0; c < a.length; c++) {
        ...
        if (F('FIGURE', b.tagName)) {
          if (((d = b.getElementsByTagName('FIGCAPTION')), (g = d.length), (b = ''), 0 < g && 2 >= g))
            for (f = 0; f < g && !b.length; f++) b = Nk(d[f]);
        } else b = '';
        (d = null != b && b.length) ||
          ((d = d = void 0), (d = e.width), 400 > d ? (d = !1) : ((d /= e.height), (d = 1.3 <= d && 3 >= d)));
        d && ((d = new mn()), (d.e = e.src), (d.a = b), (d.f = e.width), (d.b = e.height), O(this.f, d));
      }
    }
  ...
  _.tb = function () {
    if (null == this.i) {
      ...
      for (c = 0; c < a.length && !this.i.length; c++)
        (b = a[c]), (this.i = A(b, 'publisher')), !this.i.length && (this.i = A(b, 'source_organization'));
    }
    return this.i;
  };
  _.ub = function () {
  ...
  function V(a) {
    ...
    on ||
      null == $wnd.console ||
      ('function' !== typeof $wnd.console.log && 'object' !== typeof $wnd.console.log) ||
      $wnd.console.log(a);
    Jm += `${a}\n`;
  }
  var Wk = 0,
  ...
  var nn = t(27);
  function Tl(a) {
    if (0 == a.a.b.length || 0 != N(a.a, a.a.b.length - 1).b.b.length) O(a.a, new rn()), (a.b = null);
  }
  function Vl(a, b) {
    let c, d, e;
    ...
    0 == d.b.b.length
      ...
      : ((c = b.a - a.b.a),
        (c = 0 == c ? 0 : 0 > c ? -1 : 1),
        c != d.a
          ? 0 != d.a && ((d = ((e = new rn()), O(a.a, e), e)), 0 != c && O(d.b, a.b))
  ...
  function wn(a) {
    ...
    for (a = Nh(a.a, 0); a.b != a.d.c; )
      (b = (y(a.b != a.d.c), (a.c = a.b), (a.b = a.b.a), ++a.a, a.c.c)), (b = wn(b)), c.appendChild(b);
    return c;
  }
  function Mm(a) {
    let b, c;
    c = a.b.cloneNode(!1);
    1 == a.b.nodeType && ((b = Um(a.b).direction), !b.length && (b = 'auto'), c.setAttribute('dir', b));
    for (a = Nh(a.a, 0); a.b != a.d.c; )
      (b = (y(a.b != a.d.c), (a.c = a.b), (a.b = a.b.a), ++a.a, a.c.c)), (b = Mm(b)), c.appendChild(b);
    return c;
  }
  function un(a) {
    this.b = a;
  ...
  function Dn() {
    Dn = k;
    En = RegExp('((\\w+):\\s+(http:\\/\\/ogp.me\\/ns(\\/\\w+)*#))\\s*', 'gi');
    In = /^xmlns:(\w+)/i;
  ...
  function Mn(a, b, c) {
    null != c && c.length
      ? ((c = c.substr(1, c.length - 1)),
        'profile' === c ? fi(a.c, (On(), Pn), b) : 'article' === c && fi(a.c, (On(), Qn), b))
      : fi(a.c, (On(), Rn), b);
  }
  function Sn(a, b) {
    let c, d;
    ...
    c.length || ((g = a.getElementsByTagName('HEAD')), 1 == g.length && (c = A(g[0], 'prefix')));
    if (c.length)
      for (En.lastIndex = 0; ; ) {
        g = En.exec(c);
        if (!g) break;
      ...
      for (c = Tm(a), g = 0; g < c.length; g++)
        if (((f = c[g]), (e = f.nodeName.toLowerCase()), (e = In.exec(e))))
    ...
    for (g = new li(new ki(this.c).a); ni(g.a); )
      (c = ((g.b = oi(g.a)), new pi(g.c, g.b))), (e += `meta[property^\x3d"${c.b.b[c.a.b]}"],`);
    e = eg(e, 0, e.length - 1);
    c = Yk(a, e);
    for (g = 0; g < c.length; g++)
      for (f = c[g], m = A(f, 'property').toLowerCase(), e = 0; e < this.e.length; e++)
    ...
    c = this.b;
    if (0 != c.a.b.length)
      for (g = c.a.b.length - 1; 0 <= g; g--) (e = N(c.a, g)[0]), (null != e && e.length) || c.a.U(g);
    ...
    if (!(G(this.f, 'type') ? H(this.f, 'type') : '').length) throw new qb(`Required "${c}type" property is missing.`);
    if (!(G(this.f, 'url') ? H(this.f, 'url') : '').length) throw new qb(`Required "${c}url" property is missing.`);
    if (0 == co(this.b).length) throw new qb(`Required "${c}image" property is missing.`);
  ...
  n(150, 1, {}, Xn);
  _.yb = function (a, b, c) {
    this.b || ((c = c.c.eb('type')), (this.b = null != c && F(c, 'article')));
  ...
  function Tn() {
    this.b = D(w(p, 1), h, 2, 4, 'image image:url image:secure_url image:type image:width image:height'.split(' '));
    this.a = new P();
  }
  n(148, 1, {}, Tn);
  _.yb = function (a, b) {
    let c, d;
    if ('image' === a) (d = E(p, h, 2, this.b.length, 4)), (d[0] = b), O(this.a, d);
    else
      for (
        0 == this.a.b.length
  ...
  n(149, 1, {}, Un);
  _.yb = function (a, b, c) {
    this.a || ((a = c.c.eb('type')), (this.b = null != a && F(a, 'profile')), (this.a = !0));
    return this.b;
  };
  _.a = !1;
  _.b = !1;
  ...
  function fo(a) {
    if (!a.a) {
      ...
      let e, f;
      try {
        (f = U()), (e = new Sn(c, d)), Wl(f, d, 'OpenGraphProtocolParser.parse'), (b = e);
      } catch (g) {
  ...
  function sm(a) {
    ...
    for (c = new M(a.a); c.b < c.d.J(); )
      (b = (y(c.b < c.d.J()), c.d.T((c.c = c.b++)))), (d += `\n  ` + `pg${b.a}: ${b.b}`);
    return (d += `\nformula: ${a.b ? go(a.b) : 'null'}\nnextPagingUrl: ${a.c}`);
  }
  function rm() {
    this.e = (lm(), io);
    this.a = new P();
  ...
  function jm(a) {
    ...
    if ((d = 2 == a.b.length)) (d = c.a), (e = b.a), (d = 4 < (d > e ? d : e));
    if (d) return null;
    d = b.a - c.a;
    if (0 == d) return null;
    b = ~~((b.b - c.b) / d);
    ...
    for (d = 2; d < a.b.length; d++) if (((e = (z(d, a.b.length), a.b[d])), e.b != b * e.a + c)) return null;
    return new nm(b, c);
  }
  function hm(a, b) {
    let c, d, e, f, g, l, m, q;
    ...
    if (
      ((0 == e || 1 == e) && 1 == (z(0, b.b.length), b.b[0]).a && 2 == (z(1, b.b.length), b.b[1]).a) ||
      (2 == e &&
      ...
      return (q.b = !0), q;
    f = b.b.length;
    if ((c == f - 1 || c == f - 2) && (z(f - 2, b.b.length), b.b[f - 2]).a + 1 == (z(f - 1, b.b.length), b.b[f - 1]).a)
      return (q.b = !0), q;
    for (e += 1; e < c; e++)
      if ((z(e - 1, b.b.length), b.b[e - 1]).a + 2 == (z(e + 1, b.b.length), b.b[e + 1]).a) {
        q.b = !0;
        break;
      }
    return q;
  ...
  function im(a, b) {
    ...
    for (f = new M(a); f.b < f.d.J(); )
      if (((e = (y(f.b < f.d.J()), f.d.T((f.c = f.b++)))), e.b.length)) d && !b.c.length && (b.c = e.b);
      else {
        if (d) return !1;
        d = !0;
      }
    ...
    for (d = 1; d < a.b.length; d++)
      if (
        ...
        1 != c.a - e.a && ((1 != d && d != a.b.length - 1) || !c.b.length || !e.b.length))
      )
        return !1;
    return !0;
  }
  ...
  function pm(a, b) {
    ...
    if (a.a) {
      c = a.a;
      const d = b.a;
      c = c.b && !d.b ? 1 : !c.b && d.b ? -1 : c.e == d.e ? 0 : c.e == (lm(), mm) ? 1 : d.e == mm ? -1 : 0;
  ...
  function Ul(a, b, c, d, e) {
    ...
    if (!f) return (f = b.parentNode), !zo && (zo = /(BODY)|(HTML)/), zo.test(f.nodeName) ? !1 : Ul(a, f, !1, d, e);
    c = !1;
    switch (f.nodeType) {
      case 3:
        b = f.nodeValue;
        ...
        var g, l, m;
        if (em(b)) {
          Go ? (Go.lastIndex = 0) : (Go = RegExp('(\\S*[\\w\u00c0-\u1fff\u2c00-\ud7ff]\\S*)', 'gi'));
          !Ho && (Ho = /^[\W_]*(\d+)[\W_]*$/i);
          for (g = !1; ; ) {
            l = Go.exec(b);
            if (!l) break;
            1 >= l.length ||
              ...
              0 <= l && 100 >= l ? (Vl(a.a, new Yl(l, '')), (g = !0)) : Tl(a.a));
          }
          b = g;
        } else Tl(a.a), (b = !1);
        if (d || !b) return !1;
      ...
      case 1:
        if (((b = f), F('A', b.tagName))) {
          if (d) return !1;
          ++a.c;
          (b = Sl(a, b, e)) ? (Vl(a.a, b.a), (b = !0)) : (Tl(a.a), (b = !1));
          if (!b) return !1;
          break;
        }
      default:
  ...
  function tm() {
    tm = k;
    Am = RegExp('(next|weiter|continue|\x3e([^\\|]|$)|\u00bb([^\\|]|$))', 'i');
    Em = RegExp('(prev|early|old|new|\x3c|\u00ab)', 'i');
    Fm = /article|body|content|entry|hentry|main|page|pagination|post|text|blog|story/i;
    Dm = RegExp(
  ...
  function X(a, b) {
    let c;
    3 > Wk || ((c = ''), eh(um, a) && (c = gh(um, a)), !c.length || (c += '; '), hh(um, a, c + b));
  }
  function Ql(a) {
    tm();
    let b, c;
  ...
  let xm, Cm, wm, Gm, Dm, Am, ym, Bm, Fm, Em, um;
  function zm(a, b, c) {
    this.b = a;
    this.d = 0;
    this.c = b;
  ...
  function So(a) {
    let b;
    null == a.a &&
      ((b = (null == a.c && (a.c = dm(a.d)), a.c)), b.length ? (a.a = (T(), Gf(b, '\\/'))) : (a.a = E(p, h, 2, 0, 4)));
    return a.a;
  }
  function Uo(a) {
    this.d = a;
  ...
  function Vo(a) {
    ...
    b = Ko(c[a.b - 1]);
    return 0 < b && 12 >= b && ((a = Ko(c[a.b - 2])), 1970 < a && 3e3 > a) ? !0 : !1;
  }
  function Yo(a, b) {
    let c, d, e, f;
    f = b.length;
    ...
    c = a.c;
    for (d = lf(a.d, e); c < d && b.charCodeAt(c) == a.i.charCodeAt(c); c++);
    if (c == e) {
      if ((d = c + 1 == a.d))
        (d = a.i.charCodeAt(c)),
          128 > d ? ((e = (bf(), cf)[d]), !e && (e = cf[d] = new $e(d)), (d = e)) : (d = new $e(d)),
          (d = /[-_;,]/.test(d));
  ...
  function gm(a, b, c, d) {
    ...
    a: {
      if (
        ...
        Zo.test(e) &&
          ...
          (b = bp.exec(b)) && 1 < b.length && (to(), S(Y, b[1].toLowerCase()))))
      ) {
        b = !0;
        break a;
      }
    ...
    e = a.substr(c, d - c);
    b = Ko(e);
    if (0 > b) throw new df(`Value in path component is an invalid number: ${e}`);
    ...
    c = So(this.g);
    for (this.b = 0; this.b < c.length && -1 == c[this.b].indexOf('[*!]'); this.b++);
  ...
  _.zb = function (a) {
    if (this.f.length && !nf(a, this.f)) a = !1;
      ...
      a: {
        ...
        c = this.f.length;
        d = a.length - c;
        b = pf(this.g.d.pathname, 47, this.c - 1 - this.g.d.origin.length);
        ...
        Hf(a, this.e)
          ? ((b = this.c + c),
            (a = b == e ? !0 : b > e || 47 != a.charCodeAt(this.c) ? !1 : 0 <= Ko(eg(a, this.c + 1, d))))
          : (a = !1);
      }
    else a = Yo(this, a);
    return a;
  ...
  _.Ab = function (a) {
    ...
    if (1 == b && 1 == c) {
      ...
      if (c.length && a.length)
        for (d = lf(c.length, a.length), b = 0; b < d && c.charCodeAt(b) == a.charCodeAt(b); b++);
      else b = 0;
      d = b;
      var e, f, g;
      e = 0;
      f = c.length - 1;
      for (g = a.length - 1; f > d && g > d && c.charCodeAt(f) == a.charCodeAt(g); --f, --g, e++);
  ...
  function am(a, b, c, d) {
    ...
    to();
    if (S(Y, c.toLowerCase())) throw new df(`Query name is bad page param name: ${c}`);
    e = Ko(d);
  ...
  _.zb = function (a) {
    ...
    if (this.b == c || (c == this.b - 1 && 47 == this.j.charCodeAt(c))) return !0;
    b = eg(a, this.b, c).toLowerCase();
    !jp && (jp = /^\/|(.html?)$/i);
    return jp.test(b) ? !0 : qf(a, this.b, this.j, this.b, this.c - this.b) ? 0 <= Ko(eg(a, this.c, c)) : !1;
  };
  _.Ab = function (a) {
  ...
  function Hp(a) {
    let b, c, d;
    b = new P();
    for (c = 0; c < a.c.b.length; c++) (d = N(a.c, c)), d.d == (mp(), op) && O(b, d);
    return b;
  }
  function Ip(a, b, c) {
    let d, e, f, g, l;
    ...
    if (c) {
      ...
      f = A(b, 'ITEMPROP');
      f.length
        ? ((m = (T(), Gf(f, '\\s+'))), (f = 0 < m.length ? m : D(w(p, 1), h, 2, 4, [f])))
        : (f = E(p, h, 2, 0, 4));
    } else f = E(p, h, 2, 0, 4);
    if (d) {
      a: {
        var q;
        switch (((q = A(b, 'ITEMTYPE')), G(lp, q) ? H(lp, q) : (mp(), Jp)).b) {
          case 0:
            e = new Kp(b);
            break;
          case 1:
      ...
      !e || e.d == (mp(), Jp) || (c && c.d == (mp(), Jp) && 0 != f.length) || (O(a.c, e), hh(a.b, b, e));
    }
    if (0 < f.length && c.d != (mp(), Jp) && (!e || e.d != (mp(), Jp)))
      for (a = 0; a < f.length; a++)
        e
          ...
          : ((d = c),
            (q = f[a]),
            (m = ((g = ''), (l = b.tagName), G(Gp, l) && (g = A(b, H(Gp, l))), !g.length && (g = Lk(b)), g)),
  ...
  function Pp(a, b) {
    ...
    for (f = 0; f < d.length; f++) {
      for (var m = (e = d[f]), q = void 0, v = void 0, v = null, q = e; q; ) {
        q = B(q);
        if (!q) break;
    ...
    for (f = 0; f < d.length; f++)
      (e = d[f]),
        !this.a.length &&
          (this.a =
            ((g = ''), (l = e.tagName), (F(l, 'A') || F(l, 'LINK')) && F(A(e, 'REL'), 'author') && (g = Lk(e)), g));
    ...
    (d = G(a.b, b) ? H(a.b, b) : null) &&
      (d.d == (mp(), pp)
        ? (c =
            ...
            e.length
              ? e
              : Qp(G(d.c, 'givenName') ? H(d.c, 'givenName') : '', G(d.c, 'familyName') ? H(d.c, 'familyName') : '')))
        : d.d == rp &&
          (c =
            ((f = G(d.c, 'name') ? H(d.c, 'name') : ''),
            f.length ? f : G(d.c, 'legalName') ? H(d.c, 'legalName') : '')));
    return c;
  }
  function Lp(a) {
  ...
  _.pb = function () {
    ...
    b = '';
    a = Hp(this.a);
    0 != a.b.length && ((a = (z(0, a.b.length), a.b[0])), (b = Tp(a, 'author')), !b.length && (b = Tp(a, 'creator')));
  ...
  _.qb = function () {
    ...
    0 == a.b.length
      ? (a = '')
      : ((a = (z(0, a.b.length), a.b[0])),
        (a = Qp(G(a.c, 'copyrightYear') ? H(a.c, 'copyrightYear') : '', Tp(a, 'copyrightHolder'))),
  ...
  _.rb = function () {
    ...
    !this.a && (this.a = new Pp(this.b, this.c));
    a = Hp(this.a);
    return 0 == a.b.length ? '' : Rp((z(0, a.b.length), a.b[0]), 'description');
  };
  _.sb = function () {
    let a, b, c, d, e, f, g, l;
    !this.a && (this.a = new Pp(this.b, this.c));
    ...
    for (d = 0; d < b.b.length; d++) {
      ...
      if (
        !c &&
        (c =
          ((e = G(a.b, 'associatedMedia') ? H(a.b, 'associatedMedia') : null),
    ...
    d = this.a;
    b = new P();
    for (a = 0; a < d.c.b.length; a++) (e = N(d.c, a)), e.d == (mp(), np) && O(b, e);
    d = !1;
    for (e = 0; e < b.b.length; e++)
      (f = (z(e, b.b.length), b.b[e])),
        (a =
          ...
          (l.d = G(f.c, 'encodingFormat') ? H(f.c, 'encodingFormat') : ''),
          (l.a = G(f.c, 'caption') ? H(f.c, 'caption') : ''),
          (l.f = Hm(G(f.c, 'width') ? H(f.c, 'width') : '')),
          (l.b = Hm(G(f.c, 'height') ? H(f.c, 'height') : '')),
          l)),
        f == c || (!d && F(G(f.c, 'representativeOfPage') ? H(f.c, 'representativeOfPage') : '', 'true'))
  ...
  _.tb = function () {
    ...
    a = Hp(this.a);
    0 != a.b.length &&
      ((a = (z(0, a.b.length), a.b[0])), (b = Tp(a, 'publisher')), !b.length && (b = Tp(a, 'copyrightHolder')));
    return b;
  };
  _.ub = function () {
    let a, b, c;
    ...
    J = tb.c;
    q = v.c;
    Mc(0 != (J.f & 1) ? J == q : 0 == (q.f & 1), "Array types don't match");
    Ca = a.length;
    q = g.length;
    if (0 > l || 0 > f || 0 > m || l + m > Ca || f + m > q) throw new Ue();
    if ((0 != (J.f & 1) && 0 == (J.f & 4)) || tb == v) 0 < m && Re(a, l, g, f, m, !0);
    else if (s(a) === s(g) && l < f) for (l += m, m = f + m; m-- > f; ) g[m] = a[--l];
  ...
  function gq(a) {
    ...
    hq();
    for (f = B(a); f; ) {
      if (F('INPUT', f.tagName) || F(A(f, 'contenteditable'), 'true')) return fq(iq, '', (Z(), jq));
      f = B(f);
    }
    ...
    for (g = new M(f); g.b < g.d.J(); )
      if (((b = (y(g.b < g.d.J()), g.d.T((g.c = g.b++)))), (c = A(b, 'role').toLowerCase()), S(bq, c) || S(cq, c)))
        return fq(mq, `_${c}`, (Z(), lq));
    if ('0' === A(a, 'datatable')) return fq(nq, '', (Z(), jq));
    if (0 < a.getElementsByTagName('TABLE').length) return fq(oq, '', (Z(), jq));
    g = a.rows;
    if (1 >= g.length) return fq(pq, '', (Z(), jq));
    c = null;
    for (d = b = 0; d < g.length; d++) (e = g[d].cells), e.length > b && ((b = e.length), (c = e));
    d = c;
    if (!d || 1 >= d.length) return fq(qq, '', (Z(), jq));
    if (((c = a.caption) && eq(c)) || a.tHead || a.tFoot || dq(f, Zp)) return fq(rq, '', (Z(), lq));
    c = new P();
    for (e = new M(f); e.b < e.d.J(); )
      (b = (y(e.b < e.d.J()), e.d.T((e.c = e.b++)))), F('TD', b.tagName) && (c.b[c.b.length] = b);
    for (e = new M(c); e.b < e.d.J(); ) {
      b = (y(e.b < e.d.J()), e.d.T((e.c = e.b++)));
      if (b.hasAttribute('abbr') || b.hasAttribute('headers') || b.hasAttribute('scope')) return fq(sq, '', (Z(), lq));
      b = b.getElementsByTagName('*');
      if (1 == b.length && F('ABBR', b[0].tagName)) return fq(tq, '', (Z(), lq));
    }
    ...
    if (0 < b && ((a.offsetWidth || 0) | 0) > 0.95 * b) {
      ...
      for (l = 0; l < b.length && !m; l++) (m = b[l]), (m = F(m.name, 'viewport'));
    ...
    return 0 < f && ((a.offsetHeight || 0) | 0) > 0.9 * f ? fq(Cq, '', (Z(), jq)) : fq(Dq, '', (Z(), lq));
  }
  let cq, bq, aq, Zp, $p;
  function hq() {
    hq = k;
  ...
  function Kq(a) {
    let b;
    b = a.cloneNode(!1);
    1 == a.nodeType && ((a = Um(a).direction), !a.length && (a = 'auto'), b.setAttribute('dir', a));
    return b;
  }
  function Lq(a, b) {
    let c;
  ...
  function Oq(a) {
    let b;
    b = `[${N(a.j, N(a.i, 0).a).j}-${N(a.j, N(a.i, a.i.b.length - 1).a).j};`;
    b += `tl\x3d${a.f};`;
    b += `nw\x3d${a.d};`;
    b += `ld\x3d${a.c};`;
  ...
  function Pq() {
    ...
    R(Qq, 'FIGURE');
    R(Qq, 'SPAN');
    Rq = D(w(p, 1), h, 2, 4, ['data-src', 'data-original', 'datasrc', 'data-url']);
  }
  function Sq(a) {
    let b;
  ...
  function Tq(a, b) {
    ...
    if ('FIGURE' === b.tagName) {
      ...
      if (!d) return null;
      Uq(a, c);
      (c = Vm(b, 'FIGCAPTION')) ? ((e = Yk(c, 'A[HREF]')), (c = 0 < e.length ? c : Sq(c))) : (c = Sq(b));
      return new Vq(d, a.c, a.a, a.b, c);
    }
    if ('SPAN' === b.tagName) {
      if (-1 == A(b, 'class').indexOf('lazy-image-placeholder')) return null;
      c = $doc.createElement('img');
      a.b = A(b, 'data-src');
  ...
  function Uq(a, b) {
    ...
    d = Rq;
    e = 0;
    for (f = d.length; e < f && ((c = d[e]), (a.b = A(b, c)), !a.b.length); ++e);
    a.b.length ? ((a.c = 0), (a.a = 0)) : ((a.b = b.src), (a.c = b.width), (a.a = b.height));
  ...
  _.Cb = function (a) {
    ...
    a && S(Zq, a.tagName)
      ? ((b = null),
        'BLOCKQUOTE' === a.tagName ? (b = $q(a)) : 'IFRAME' === a.tagName && (b = br(a)),
        b && 2 <= Wk && (V('Twitter embed extracted:'), V(`    ID: ${b.b}`)),
        (a = b))
      : (a = null);
    return a;
  };
    ...
    'IFRAME' === a.tagName
      ...
      : 'OBJECT' === a.tagName &&
        ('application/x-shockwave-flash' === A(a, 'type')
          ? (d = A(a, 'data'))
          : ((b = Yk(a, 'param[name\x3d"movie"]')), 1 == b.length && (d = A(b[0], 'value'))));
  ...
  function hl(a, b, c) {
    if (!(1 > Wk))
      if (b) {
        V(`\u001b[0;34m\x3c\x3c\x3c\x3c\x3c ${c} \x3e\x3e\x3e\x3e\x3e`);
        if (!(1 > Wk)) {
          b = '';
          for (c = new M(a.a); c.b < c.d.J(); ) (a = (y(c.b < c.d.J()), c.d.T((c.c = c.b++)))), (b += `${Oq(a)}\n`);
          V(b);
        }
        V('\u001b[0;34m\x3c\x3c\x3c\x3c\x3c                \x3e\x3e\x3e\x3e\x3e');
  ...
  function sl(a, b) {
    ...
    for (f = new th(c, 1); f.b < f.d.J(); )
      (c = (y(f.b < f.d.J()), f.d.T((f.c = f.b++)))),
        c.a && g.a
          ? ((e = N(c.j, N(c.i, 0).a).j - N(g.j, N(g.i, g.i.b.length - 1).a).j - 1),
            1 >= e
              ? ((e = !0),
                a.a ? g.f != c.f && (e = !1) : S(c.b, 'BOILERPLATE_HEADING_FUSED') && (e = !1),
                S(g.b, 'STRICTLY_NOT_CONTENT') != S(c.b, 'STRICTLY_NOT_CONTENT') && (e = !1),
                S(g.b, 'de.l3s.boilerpipe/TITLE') != S(c.b, 'de.l3s.boilerpipe/TITLE') && (e = !1),
                !g.a && S(g.b, 'de.l3s.boilerpipe/LI') && !S(c.b, 'de.l3s.boilerpipe/LI') && (e = !1),
  ...
  function or(a, b, c) {
    ...
    e = Gf(b, c);
    if (1 != e.length)
      for (b = 0; b < e.length; b++) (d = e[b]), -1 == d.indexOf('.com') && ((c = (T(), Mk.Bb(d))), 4 <= c && R(a, d));
  }
  function pr(a, b) {
    let c, d, e, f, g, l;
    l = Gf(a, b);
    ...
    for (c = 0; c < l.length; c++)
      if (((g = l[c]), -1 == g.indexOf('.com') && ((f = (T(), Mk.Bb(g))), f > d || g.length > e.length)))
        (d = f), (e = g);
  ...
  function rr(a, b, c) {
    b = N(a.d, b);
    c = N(a.d, c);
    return a.c || (b.nodeType != c.nodeType ? 0 : 1 != b.nodeType || b.nodeName === c.nodeName)
      ? b.parentNode == c.parentNode
      : !1;
  }
  function ql(a, b) {
    let c, d, e, f, g, l, m, q, v, J;
    a.g = b.a;
    ...
    for (f = 0; f < d.b.length; ++f) {
      g = f + 1 == d.b.length ? e : Mq((z(f + 1, d.b.length), d.b[f + 1]));
      0 == f ? (m = e) : ((m = (z(f - 1, d.b.length), d.b[f - 1])), (m = Al(N(m.j, N(m.i, m.i.b.length - 1).a))));
      v = m;
      m = Mq((z(f, d.b.length), d.b[f]));
      for (q = m.parentNode; !q.contains(v) && !q.contains(g); ) (m = q), (q = q.parentNode);
      l.b[l.b.length] = m;
    }
    a.d = l;
    ...
    for (v = 0; v < a.g.b.length; v++)
      if ((!a.b && Nq(N(a.g, v), 'de.l3s.boilerpipe/TITLE')) || (!a.a && Nq(N(a.g, v), 'de.l3s.boilerpipe/HEADING')))
        (m = q), (e = f);
      else if (N(a.g, v).a && !Nq(N(a.g, v), 'STRICTLY_NOT_CONTENT') && !Nq(N(a.g, v), 'de.l3s.boilerpipe/TITLE'))
        for (l[q++] = v, J = e; J < f; J++)
          (c = d[J]), v - c > a.e ? J == e && ++e : rr(a, v, c) && ((g = !0), ml(N(a.g, c), !0), (d[J] = d[e++]));
      else if (
        N(a.g, v).c <= a.f &&
        !N(a.g, v).a &&
  ...
  function xr(a, b) {
    ...
    g = l = !1;
    m ||
      (a.i && a.d && (a.f || (g = (W(), b.classList.contains('hidden'))), (a.f || g) && (l = !0)),
      a.i && (-1 != A(b, 'class').indexOf('continue') && (l = !0), 'false' === A(b, 'aria-expanded') && (l = !0)));
    let q = m || l,
      v;
    2 > Wk ||
      ((v = Um(b)),
      V(
        `${(q ? 'KEEP ' : 'SKIP ') + b.tagName}: id\x3d${b.id}, dsp\x3d${v.display}, vis\x3d${v.visibility}, opaq\x3d${
          v.opacity
        }`,
      ));
    ...
    try {
      if (S(a.b, b.tagName))
        for (f = new M(a.c); f.b < f.d.J(); )
          if (((e = (y(f.b < f.d.J()), f.d.T((f.c = f.b++)))), (d = e.Cb(b))))
            return (c = a.a), dl(c, c.d), O(c.b.a, d), !1;
    } catch (J) {
      if (((J = qc(J)), r(J, 15))) (c = J), V(`Exception happened in EmbedExtractors: ${c.q()}`);
      else throw rc(J);
    }
    c = A(b, 'class');
    d = A(b, 'data-component');
    if ('sharing' === c || 'socialArea' === c || 'share' === d) return !1;
    Ur(b.tagName) && ((d = a.a), (e = new as(b.tagName, (Gl(), Hl))), dl(d, d.d), O(d.b.a, e));
    switch (b.tagName) {
      case 'A':
        if ((c = -1 != b.href.indexOf('action\x3dedit\x26section\x3d'))) return !1;
        break;
      case 'SPAN':
        if ('mw-editsection' === c) return !1;
        break;
      case 'BR':
        return (g = a.a), g.c && (dl(g, g.d), ++g.d, (g.c = !1)), (g = g.g), (g.j += '\n'), O(g.a, b), !1;
      case 'TABLE':
        c = gq(b);
        2 > Wk ||
          ((d = B(b)),
          V(
            `TABLE: ${c}, id\x3d${b.id}, class\x3d${A(b, 'class')}, parent\x3d[${d.tagName}, id\x3d${
              d.id
            }, class\x3d${A(d, 'class')}]`,
          ));
        if (c == (Z(), lq)) return (g = a.a), dl(g, g.d), O(g.b.a, new bs(b)), !1;
        break;
      case 'VIDEO':
    ...
    if ('HTML' !== e && 'BODY' !== e && 'ARTICLE' !== e)
      switch (
        ...
        (m = A(b, 'id')),
        (ks.test(l) || ks.test(m)) && 2 >= f && ((f = d.d), (f[f.length] = 'STRICTLY_NOT_CONTENT')),
        e)
      ) {
        case 'ASIDE':
        case 'NAV':
  ...
  function Zk(a) {
    ...
    O(this.c, new kr());
    this.b = new Ci();
    for (b = new M(this.c); b.b < b.d.J(); ) (a = (y(b.b < b.d.J()), b.d.T((b.c = b.b++)))), Ag(this.b, a.Db());
  }
  n(124, 1, {}, Zk);
  _.mb = function (a) {
  ...
  function dl(a, b) {
    ...
    c.c == c.a.b.length
      ...
      : c.d < c.c
        ? (ns(c), (c = null))
        : ((d = new os(c.j, c.a, c.c, c.a.b.length, c.d, c.f, c.i, c.g, c.b, d)), ns(c), (c = d));
    if (c) {
      c.d = b;
      ++a.e;
      let e, f;
      for (e = new M(a.a.a); e.b < e.d.J(); )
        for (d = (y(e.b < e.d.J()), e.d.T((e.c = e.b++))), f = 0; f < d.d.length; f++) R(c.e, d.d[f]);
      O(a.b.a, c);
    }
  }
  function Xk() {
  ...
  n(51, 216, { 51: 1 }, as);
  _.Eb = function (a) {
    return a ? '' : `\x3c${this.b == (Gl(), Hl) ? '' : '/'}${this.a}\x3e`;
  };
  let ts;
  t(51);
  function Gl() {
  ...
  _.Eb = function (a) {
    ...
    1 != b.nodeType && ((c = B(uh(new vh(this.a, this.k, this.b), 0)).cloneNode(!1)), c.appendChild(b), (b = c));
    'BODY' === b.tagName && ((c = $doc.createElement('div')), (c.innerHTML = b.innerHTML || ''), (b = c));
    for (d = null; S(ws(), b.tagName); ) {
      d || ((d = al(new vh(this.a, this.k, this.b))), 1 != d.nodeType && (d = B(d)));
      d = B(d);
    ...
    1 == c.nodeType &&
      ...
      (-1 != A(c, 'class').indexOf('caption') ? (c.className = 'caption') : c.removeAttribute('class'));
    c = Yk(c, '[class]');
    for (d = 0; d < c.length; d++)
      -1 != A(c[d], 'class').indexOf('caption') ? (c[d].className = 'caption') : c[d].removeAttribute('class');
  ...
  _.Fb = function (a) {
    ...
    for (b = new M(a); b.b < b.d.J(); )
      if (((a = (y(b.b < b.d.J()), b.d.T((b.c = b.b++)))), 1 == a.nodeType && 'FIGURE' === a.tagName)) return this.a;
    return 0;
  };
  _.Hb = function () {
    return this.a;
  ...
  (function () {
    null == oa && (oa = []);
    for (let a = oa, b = 0; b < arguments.length; b++) a.push(arguments[b]);
  })(() => {
  ...
  'object' === typeof window && 'object' === typeof window.$gwt && (window.$gwt.permProps = zs);
...
(function () {
  ...
  const res = org.chromium.distiller.DomDistiller.applyWithOptions(options);
  console.log(res);
